<template>
  <main v-if="productsLoading" class="content container">Загрузка товара...</main>
  <main v-else-if="productsLoadingFailed" class="content container">
    Не получилось загрузить товар
  </main>
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            имеет степень защиты от влаги IPX7. Это означает, что устройство не боится пыли,
...
export default {
  ...
  methods: {
    ...
    addToCart() {
      ...
      this.addProductsToCart({ productId: this.product.id, amount: this.productAmount })
        .then(() => {
